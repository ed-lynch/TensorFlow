...
But in addition, Keras can now make use of built-in TensorFlow functionality which wasn't previously possible. For example, you can take your 1:1 Keras code and TensorFlow will scale it to a large GPU or TPU cluster. We'll have a look at this in the next chapter.
